...
class ConfirmStocks extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    getData = (item) => {
        ...
        return new Promise((resolve, reject) => {
            ...
            axios
                .get("http://10.117.189.137:9093/trading/purchased/" + userId + "/status/ACCEPTED")
                .then(response => {
                    resolve(response);
        ...
        return (
            <div className="row">
                <div className="container header-title">
                    <span className="list-title">List of Confirmed Stocks</span>
